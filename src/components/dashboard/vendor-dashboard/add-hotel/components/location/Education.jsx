            ...
            <tr>
              <td className="col-2">
                ...
                <div className="form-input ">
                  <input type="text" required placeholder="Enter details of Sunny beach" className=" w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all placeholder-gray-400" />
                </div>
              </td>
              <td className="col-6">
                <label className="lh-1 text-16 text-light-1">Content</label>
                <div className="form-input ">
                  <textarea required rows={5} defaultValue={""} placeholder="Content" />
                </div>
              </td>
              <td className="col-2">
                <label className="lh-1 text-16 text-light-1">Sunny beach</label>
                <div className="form-input ">
                  <input type="text" required  placeholder="Sunny beach" className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all placeholder-gray-400" />
                </div>
              </td>
              <td className="col-2">
