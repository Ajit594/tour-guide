              ...
              <table className="table-3 -border-bottom col-12">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>$35</td>
                    <td>
                      <span className="rounded-100 py-4 px-10 text-center text-14 fw-500 bg-blue-2 text-blue-1">
                        Pending
                      </span>
                    </td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td>$35</td>
                    <td>
                      <span className="rounded-100 py-4 px-10 text-center text-14 fw-500 bg-green-1-05 text-green-2">
                        Confirmed
                      </span>
                    </td>
                    <td>
