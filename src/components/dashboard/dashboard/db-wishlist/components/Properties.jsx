            ...
            <div className="col-md-auto">
              <div className="cardImage ratio ratio-1:1 w-200 md:w-1/1 rounded-4">
                ...
                <div className="cardImage__wishlist">
                  <button className="button -yellow-1 bg-white size-30 rounded-full shadow-2">
                ...
                <div className="col-auto">
                  <p className="text-14">
                    ...
                    <button
                      ...
                      className="text-yellow-1 underline ml-10"
                    >
                      Show on map
                    </button>
                  </p>
            ...
            <div className="col-md-auto text-right md:text-left">
              <div className="d-flex flex-column justify-between h-full">
                <div className="row x-gap-10 y-gap-10 justify-end items-center md:justify-start">
                  ...
                  <div className="col-auto">
                    <div className="flex-center text-white fw-600 text-14 size-40 rounded-4 bg-yellow-1">
                      {item?.ratings}
                    </div>
                  </div>
                </div>
